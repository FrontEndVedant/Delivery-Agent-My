...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Run simulations, comparisons, and analysis for the delivery agent.',
...
Examples:
  ...
  Run full experiment and analyze results:
    ...
    parser.add_argument('--verbose', '-v', action='store_true', help='Print full tracebacks on errors')
